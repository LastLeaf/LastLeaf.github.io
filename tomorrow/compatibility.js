...
document.bindReady(function(){
	if(HTML5Compatibility.supportAll()) {
		document.getElementById('game_web').innerHTML = '<a href="javascript:;" id="game_web_start">Start Game</a>';
		...
		document.getElementById('game_web').innerHTML = 'Your browser does not support the web version. You may use <a href="http://www.google.com/chrome">Chrome</a> or <a href="http://firefox.com">Firefox</a> to access.';
});